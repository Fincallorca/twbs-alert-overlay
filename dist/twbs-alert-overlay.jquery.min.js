...
b.content).appendTo(a)}.bind(this));return a},this._getAlertElement=function(a,b){return $('<div class="alert alert-'+a+'" role="alert">'+b+"</div>")},this._showOverlay=function(){var a=$("body");document.body.scrollHeight>document.documentElement.clientHeight&&a.css("overflow-y","scroll");document.body.scrollWidth>document.documentElement.clientWidth&&a.css("overflow-x","scroll");a.addClass("alert-overlay-open");this.$_overlay.html(this._getAlertsElement()).show()},this._hideOverlay=function(){$("body").removeClass("alert-overlay-open");
this.$_overlay.hide()},this._initializeOverlay())}TwbsAlertOverlay.DEFAULTS={overlay:"#alert-overlay",overlayAuto:!0,messages:[]};
