(function(d){null==d.twbsAlertOverlay&&(d.twbsAlertOverlay=function(a){return new TwbsAlertOverlay(a)})})($);function TwbsAlertOverlay(d){this._options=$.extend(TwbsAlertOverlay.DEFAULTS,d||{});0!==this._options.messages.length&&(this.$_overlay=null,TwbsAlertOverlay._scrollPosition={top:null,left:null},this._fnNoScroll=null,this._createOverlay=function(){var a=this._options.overlay.split(" "),a=a[a.length-1],b="div",c="";-1<a.search(/^[^#\.]+/g)&&(b=a.match(/^[^#\.]+/g));b=$(document.createElement(b));if(-1<a.search(/#[^#\.\s]+/g)){c=a.match(/#[^#\.\s]+/g).map(function(a){return a.substring(1)});if(1<c.length)throw Error("Multiple ids in option overlay: "+
...
b.content).appendTo(a)}.bind(this));return a},this._getAlertElement=function(a,b){return $('<div class="alert alert-'+a+'" role="alert">'+b+"</div>")},this._showOverlay=function(){TwbsAlertOverlay._scrollPosition.top=document.documentElement.scrollTop;TwbsAlertOverlay._scrollPosition.left=document.documentElement.scrollLeft;var a=$("body");document.body.scrollHeight>document.documentElement.clientHeight&&a.css("overflow-y","scroll");document.body.scrollWidth>document.documentElement.clientWidth&&
a.css("overflow-x","scroll");a.addClass("alert-overlay-open");this.$_overlay.html(this._getAlertsElement()).show()},this._hideOverlay=function(){$("body").removeClass("alert-overlay-open");this.$_overlay.hide()},this._initializeOverlay())}TwbsAlertOverlay.DEFAULTS={overlay:"#alert-overlay",overlayAuto:!0,messages:[]};$(document).on("scroll",function(){$("body").hasClass("alert-overlay-open")&&window.scrollTo(TwbsAlertOverlay._scrollPosition.left,TwbsAlertOverlay._scrollPosition.top)});
